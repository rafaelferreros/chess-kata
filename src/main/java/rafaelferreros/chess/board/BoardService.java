...
public class BoardService {
    ...
    public Board initializeBoard() {
        ...
        boardMatrix[0] = Piece.ROOK_INIT.getCode();
        boardMatrix[1] = Piece.KNIGHT.getCode();
        boardMatrix[2] = Piece.BISHOP.getCode();
        boardMatrix[3] = Piece.QUEEN.getCode();
        boardMatrix[4] = Piece.KING_INIT.getCode();;
        boardMatrix[5] = Piece.BISHOP.getCode();
        boardMatrix[6] = Piece.KNIGHT.getCode();
        boardMatrix[7] = Piece.ROOK_INIT.getCode();
        boardMatrix[8] = Piece.PAWN_INIT.getCode();
        boardMatrix[9] = Piece.PAWN_INIT.getCode();
        boardMatrix[10] = Piece.PAWN_INIT.getCode();
        boardMatrix[11] = Piece.PAWN_INIT.getCode();
        boardMatrix[12] = Piece.PAWN_INIT.getCode();;
        boardMatrix[13] = Piece.PAWN_INIT.getCode();
        boardMatrix[14] = Piece.PAWN_INIT.getCode();
        boardMatrix[15] = Piece.PAWN_INIT.getCode();
